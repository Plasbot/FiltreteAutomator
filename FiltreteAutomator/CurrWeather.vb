Public Class CurrWeather
    'Re-pasted to make this new class.  The one I was getting from pasting the string from visual studio was CurrentWeather, and wasn't working.
    'Although this one isn't working either, i got the xml sample from fiddler, which does not have the extra quotes around everything.
    '''<remarks/>
    <System.SerializableAttribute(),
 System.ComponentModel.DesignerCategoryAttribute("code"),
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True),
 System.Xml.Serialization.XmlRootAttribute([Namespace]:="Weather", IsNullable:=False)>
